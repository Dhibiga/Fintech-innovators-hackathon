...
1. Unified Sync Navigate to the Connect tab and select "SGFinDex" or "Web3". The Wealth Wallet will instantly aggregate your fragmented bank, CPF, and crypto balances into one real-time view.

2. Wellness Assessment Click the Wellness Score card on the dashboard. Use the interactive charts to toggle through dimensions like Liquidity or Diversification to see real-time health indicators and risk flags.

3. Autopilot Approvals Check the Action Queue for proactive suggestions (e.g., "Move idle cash to T-Bills"). Review the data-driven rationale and click Approve to simulate the transaction and update your score.

4. Behavioral Circuit Breakers Simulate a high-risk trade during market volatility. A Behavioral Intervention popup will appear, surfacing your historical trading patterns and providing a "cooling-off" prompt to prevent emotional selling.
